...
<?php if ( (  WC()->cart->needs_shipping() || get_option('woocommerce_require_shipping_address') == 'yes' ) && !  WC()->cart->ship_to_billing_address_only() ) : ?>
    ...
    <p class="form-row" id="ship-to-different-address">
        <input id="shiptobilling-checkbox" class="input-checkbox" <?php checked($shiptobilling, 1); ?> type="checkbox" name="ship_to_different_address" value="1" data-woocommerce-version="<?php echo WC_VERSION ?>"/>
