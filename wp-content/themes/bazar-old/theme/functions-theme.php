...
if ( is_admin() && false === get_transient( 'yit_removeYIWLink' ) && version_compare( wp_get_theme()->get( 'Version' ), '2.4.4', '<=')  ) {
    ...
    function convert_yit_url( &$item, $key, $type ) {
        ...
        switch ( $type ) {
            ...
            case 'in_export' :
                ...
                yit_update_db_value('bazar',$item,$item_type,$type);
                yit_update_db_value('cheope',$item,$item_type,$type);
