...
if ( ! class_exists( 'YITH_WCWL_Init' ) ) {
    ...
    class YITH_WCWL_Init {
        ...
        public function init() {
		    ...
		    if(!isset($this->colors_options['add_to_wishlist_hover'])) $this->colors_options['add_to_wishlist_hover'] = array( 'background' => '#2F2F2F', 'color' => '#FFFFFF', 'border_color' => '#2F2F2F' );
            if(!isset($this->colors_options['add_to_cart_hover'])) $this->colors_options['add_to_cart_hover'] = array( 'background' => '#2F2F2F', 'color' => '#FFFFFF', 'border_color' => '#2F2F2F' );		
            if ( empty( $db_colors ) ) {
