...
<?php if ( comments_open() ) : ?><div id="reviews"><?php
	...
	$comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . __( 'Your Review', 'yit' ) . '</label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" placeholder="' . __( 'YOUR REVIEW', 'yit' ) . '"></textarea></p>' . $woocommerce->nonce_field('comment_rating', true, false);
