...
?>
            ...
            <div id="page-meta" class="group<?php if ( is_product() ) echo ' span12' ?>">
        		...
        		<?php if ( is_single() && yit_get_option('shop-show-back') ) : ?>
        			<div class="back-shop"> <a href="<?php echo get_permalink( woocommerce_get_page_id( 'shop' ) ) ?>">&lsaquo; <?php echo apply_filters( 'yit_back_shop_link', __( 'Back to the shop', 'yit' ) ); ?></a> </div>
				<?php endif; ?>
        	</div>
        	<!-- END PAGE META -->   