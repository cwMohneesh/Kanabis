                    ...
                    <tr class = "<?php echo esc_attr( apply_filters('woocommerce_cart_item_class', 'cart_item', $values, $cart_item_key ) ); ?>">
                        ...
                        <td class="product-thumbnail">
                            <?php
                                ...
                                if ( ! $_product->is_visible() || ( ! empty( $_product->variation_id ) && ! $_product->parent_is_visible() ) ) {
                                    ...
                                    /**
                                     * @deprecated woocommerce_in_cart_product_id
                                     * @see woocommerce/includes/wc-deprecated-functions.php
                                     */
                                    //printf('<a href="%s">%s</a>', esc_url( get_permalink( apply_filters('woocommerce_in_cart_product_id', $values['product_id'] ) ) ), $thumbnail );
                                    printf('<a href="%s">%s</a>', esc_url( get_permalink( $values['product_id'] ) ), $thumbnail );
                                }
                            ?>
                        </td>
                        ...
                        <td class="product-name">
                            <?php
                                if ( ! $_product->is_visible() || ( ! empty( $_product->variation_id ) && ! $_product->parent_is_visible() ) ) {
                                     ...
                                     * @see woocommerce/includes/wc-deprecated-functions.php
                                     */
                                    //printf('<a href="%s">%s</a>', esc_url( get_permalink( apply_filters('woocommerce_in_cart_product_id', $values['product_id'] ) ) ), apply_filters( 'woocommerce_cart_item_name', $_product->get_title(), $values, $cart_item_key ) );
                                    printf('<a href="%s">%s</a>', esc_url( get_permalink( $values['product_id'] ) ), apply_filters( 'woocommerce_cart_item_name', $_product->get_title(), $values, $cart_item_key ) );
                                }
                        ...
                        <td class="product-price">
                            <?php
                                ...
                                echo apply_filters('woocommerce_cart_item_price', wc_price( $product_price ), $values, $cart_item_key );
                            ?>
                        </td>
